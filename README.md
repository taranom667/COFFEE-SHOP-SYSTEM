...
مشارکت در این پروژه خوش‌آمد است! لطفاً برای افزودن ویژگی‌ها یا اصلاح با pull request اقدام کنید.
...
اگر بخوای، می‌تونم یه نسخه خیلی کوتاه و جذاب برای صفحه اصلی GitHub هم بسازم که شلوغ نباشه و جذابیت بصری داشته باشه تا بازدیدکننده سریع بفهمه پروژه چیه و چطور اجراش کنه.  

میخوای اون نسخه هم آماده کنم؟
